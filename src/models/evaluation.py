...
# initialize dagshub
import dagshub
dagshub.init(repo_owner='josephjelson06', 
             repo_name='swiggy-delivery-time-prediction', 
             mlflow=True)

# set the mlflow tracking server
mlflow.set_tracking_uri("https://dagshub.com/josephjelson06/swiggy-delivery-time-prediction.mlflow")
...
if __name__ == "__main__":
    ...
    with mlflow.start_run() as run:
        ...
        # log the final model
        mlflow.sklearn.log_model(model,"model",signature=model_signature, serialization_format="cloudpickle")
